...
- After contact_supervisor with reason "need_decision", stay alive and continue only after the reply arrives. Do not finish your final response with a choose-one question, nor with a cadence/pacing/permission question ("keep this rhythm?", "should I continue?") — continue; only a real gate pauses (via contact_supervisor).
