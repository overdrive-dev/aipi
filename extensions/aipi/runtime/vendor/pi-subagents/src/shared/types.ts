...
export interface ResourceLimitExceeded {
	kind: "maxExecutionTimeMs" | "maxTokens" | "maxToolCalls";
	limit: number;
	observed?: number;
	message: string;
}
...
export const TEMP_ROOT_DIR = process.env.AIPI_SUBAGENTS_RUNTIME_DIR
	? path.resolve(process.env.AIPI_SUBAGENTS_RUNTIME_DIR)
